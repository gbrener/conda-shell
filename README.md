...
**Note: `conda-shell` is still in _alpha/experimental_, and only tested on Linux and OSX, Python 2.7/3.5/3.6. GitHub issues (bug reports, feature requests, etc) and PRs are welcome.**
